...
class ImageForensics:
    ...
    def _analyze_metadata(self, exif_data: Dict) -> Dict:
        ...
        # Check for editing software — guard against None
        raw_software = exif_data.get("software")
        software = raw_software.lower() if isinstance(raw_software, str) else ""
    ...
    def _determine_verdict(self, exif_data: Dict, manipulation_check: Dict) -> str:
        ...
        if manipulation_check["detected"]:
            ...
            # Missing EXIF is a common signal for AI-generated or edited images
            return "SUSPECT"
        else:
            return "AUTHENTIC"
